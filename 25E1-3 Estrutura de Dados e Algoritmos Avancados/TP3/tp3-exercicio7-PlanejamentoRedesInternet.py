class GrafoAlgoritmoPrim:
    ...
    def prim(self):
        ...
        for i in range(1, self.V):
            print(f"{self.bairros[pai[i]]} - {self.bairros[i]} (R$: {self.grafo[i][pai[i]]})")
...
arestas = [
    ("Centro", "Sao Domingos", 2000), ("Centro", "Inga", 4000), ("Sao Domingos", "Inga", 1000),
    ("Sao Domingos", "Icarai", 3000), ("Inga", "Icarai", 2000), ("Inga", "Santa Rosa", 4000),
    ("Icarai", "Santa Rosa", 2000), ("Icarai", "Vital Brasil", 2000), ("Santa Rosa", "Vital Brasil", 3000)
]
